...
export default function AdminApplicationDetailsPage() {
    ...
    const { data: application, loading, error, refetch } = useApi(`/applications/${id}`);
    const { mutate: updateStatus, loading: updating } = useMutation('patch', {
    ...
    return (
        <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            <div className="mb-8">
                <Link href="/admin/applications" className="text-green-600 hover:text-green-500 mb-4 inline-block">
                    &larr; Back to Applications
                </Link>
